...
class DBHelper {
    ...
    public function migrate() {
        ...
        self::execute('"C:\Users\Menna Nour\.config\herd-lite\bin\php" "' . base_path('artisan') . '" migrate:fresh --seed');
        self::execute('"C:\Users\Menna Nour\.config\herd-lite\bin\php" "' . base_path('artisan') . '" migrate');
        self::execute('"C:\Users\Menna Nour\.config\herd-lite\bin\php" "' . base_path('artisan') . '" passport:install --force');
